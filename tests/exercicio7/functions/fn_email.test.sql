...
SELECT is(ex7_helpers.fn_email('maria.sinisgmail.com'), FALSE, 'Email inválido');

SELECT diag('Retorna FALSE se o email nao tiver dominio');
SELECT is(ex7_helpers.fn_email('maria.sinis@gmail'), FALSE, 'Email inválido');

SELECT diag('Retorna FALSE se o email tiver simbolo');
SELECT is(ex7_helpers.fn_email('m@ria.s!n!s@gmail.com'), FALSE, 'Email inválido');
