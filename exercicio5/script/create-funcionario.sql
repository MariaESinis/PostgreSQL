...
--ALTER TABLE ex5_rh.funcionario ADD CONSTRAINT fk_departamento_id FOREIGN KEY(departamento_id) REFERENCES ex5_rh.departamento(id) DEFERRABLE INITIALLY IMMEDIATE;